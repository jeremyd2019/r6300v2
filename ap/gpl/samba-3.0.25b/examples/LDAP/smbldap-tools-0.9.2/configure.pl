...
# $Id: configure.pl,v 1.1.1.1 2010-07-16 07:33:12 winniec Exp $
# $Source: /ramdisk/repositories/20_cvs_clean_up/2011-02-11_sj/src/router/samba/samba-3.0.25b/examples/LDAP/smbldap-tools-0.9.2/configure.pl,v $
