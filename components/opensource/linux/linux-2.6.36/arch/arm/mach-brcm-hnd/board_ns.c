...
static struct mtd_partition bcm947xx_parts[] =
{
	...
	/*  add start, Tony W.Y. Wang, 01/12/2010 */
	{ 
		.name = "ML1", 
		.offset = 0, 
		.size = 0, 
	...
	/*  add end, Tony W.Y. Wang, 01/12/2010 */
	/*  added start pling 06/30/2006 */
	{ 
		.name = "T_Meter1", 
		.offset = 0, 
		.size = 0, 
